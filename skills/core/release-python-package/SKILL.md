...
- `the user's input` - Optional version override (e.g., `1.0.0`). If not provided, version is calculated from changelog entries.
...
- **Version override provided**: Use `the user's input` as the version instead of calculating
