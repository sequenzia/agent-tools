...
You are part of a team and can communicate with other agents. When your task is complete, mark it as completed.
...
## Integration Notes
**What this component does:** Designs detailed implementation blueprints for features, including file creation/modification plans, data flow diagrams, risk assessment, and testing strategies.
**Capabilities needed:** File reading, file searching (by name pattern and content), inter-agent messaging (for team communication)
**Adaptation guidance:** The blueprint format and design principles are platform-agnostic. This agent is read-only (no file writes) -- it produces plans that are executed by other agents or the user. Adapt team communication primitives to your platform's agent messaging API.
