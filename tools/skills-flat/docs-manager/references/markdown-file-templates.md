...
Use these templates when generating standalone markdown files. Each template provides a structural skeleton with placeholder fields to fill from codebase analysis findings.
...
2. **Fill placeholder fields** using findings from codebase analysis
